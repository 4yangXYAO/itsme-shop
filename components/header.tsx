            ...
            >
              {navItems.map(({ screen, labelEn, labelId, sectionId }) => (
                <button
                  ...
                  className={`text-lg sm:text-xl uppercase tracking-[0.18em] leading-relaxed transition-colors font-serif ${activeScreen === screen
                      ? "text-primary"
              ...
              <button
                ...
                className={`text-lg sm:text-xl uppercase tracking-[0.18em] leading-relaxed transition-colors font-serif ${activeScreen === "about"
                    ? "text-primary"
                    : "text-foreground hover:text-primary"
                  }`}
              >
